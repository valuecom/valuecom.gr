...
<main id="content">
    ...
    <section class="page-title-section">
        <div class="container-xxl">
            <div class="page-title-wrap my-5 px-5">
                <h1 class="page-title fs-1 fw-normal text-center text-lg-start">We have faces</h1>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="container-xxl">
            <div class="row">
                <div class="col-12 the-team-cards d-grid px-md-5 px-xxl-0 pb-5">
                    <div class="card">
                        <img src="../assets/images/the-team/manos.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Alexandros Manos</h5>
                    ...
                    <div class="card">
                        <img src="../assets/images/the-team/virna.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Virna Ntanou</h5>
                            <p class="card-text">Deputy CEO, Partner </p>
                            <hr>
                    ...
                    <div class="card">
                        <img src="../assets/images/the-team/daskalopoulos.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Vassilios Dascalopoulos</h5>
                            <p class="card-text">Vice President Corporate Affairs</p>
                            <hr>
                    ...
                    <div class="card">
                        <img src="../assets/images/the-team/rania.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Rania Chartofylaka</h5>
                            <p class="card-text">Senior Content Director, Stardust GM</p>
                            <hr>
                    ...
                    <div class="card">
                        <img src="../assets/images/the-team/mitsi.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Mitsi Staikou</h5>
                            <p class="card-text">Senior Content Director</p>
                            <hr>
                    ...
                    <div class="card">
                        <img src="../assets/images/the-team/athina.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Athina Georgiadou</h5>
                            <p class="card-text">Creative Content Director</p>
                            <hr>
